...
void Stats::Init(int statAtack, int statAgility, int statDurability, int statHP, int statEnergy, Resistance res) /*Содание*/
{
	this->res = res; 
...
void Stats::Input() /*Создание вручную*/
{
...
void Stats::Print() /*Вывод информации*/
{
