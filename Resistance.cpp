...
void Resistance::Init(int resistancePoison, int resistanceFire, int resistanceFrost)   /*Создание*/
{
...
void Resistance::Input()   /*Создание вручную*/
{
...
void Resistance::Print()  /*Вывод информации*/
{
